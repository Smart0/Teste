...
class Central extends CommonGLPI {
   ...
   function getTabNameForItem(CommonGLPI $item, $withtemplate=0) {
   		...
   		global $CFG_GLPI; /* CUSTOM - Thiago Passamani */
      ...
      if ($item->getType() == __CLASS__) {
         ...
         if ($CFG_GLPI["no_central_view_rss"]) {
   ...
   **/
   static function showMyView() {
      ...
      if ($showticket) {
         ...
         //Ticket::showCentralList(0, "survey", false); /* Thiago Passamani - Pesquisa de Satistação */
         ...
         Ticket::showCentralList(0, "in_attendance", false); /* Thiago Passamani - Em atendimento */
         Ticket::showCentralList(0, "feedback", false); /* Thiago Passamani - Aguardando feedback */
         Ticket::showCentralList(0, "waiting", false);
         Ticket::showCentralList(0, "waiting_list", false); /* Thiago Passamani - Lista de espera */ 
      }
      if ($showproblem) {
      ...
      /**
       * Thiago Passamani - Botão Adicionar chamado na tela inicial
       */
      echo "<table class='tab_cadrehov'><tbody><tr class='noHover'><th>";
      echo "<a href='".$CFG_GLPI["root_doc"]."/front/ticket.form.php'>".__('Create ticket')."</a>";
      echo "</th></tr></tbody></table><br />";

      Ticket::showCentralList(0, "survey", false); /* Thiago Passamani - Pesquisa de Satistação */
      echo "<br />"; /* Thiago Passamani - Pesquisa de Satistação */
   ...
   **/
   static function showGroupView() {
      ...
      if ($showticket) {
         ...
         Ticket::showCentralList(0, "in_attendance", true); /* Thiago Passamani - Em atendimento */
         Ticket::showCentralList(0, "feedback", true); /* Thiago Passamani - Aguardando feedback */
         Ticket::showCentralList(0, "waiting_list", true); /* Thiago Passamani - Lista de espera */ 
      }
