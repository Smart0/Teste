...
abstract class CommonITILObject extends CommonDBTM {
   ...
   // STATUS // CUSTOM STATUS 13,14,15 - Thiago Passamani 
   const INCOMING      = 1; // new
   const ASSIGNED      = 2; // assign
   const PLANNED       = 3; // plan
   const IN_ATTENDANCE = 15; // in_attendance - Thiago Passamani - Em atendimento */
   const FEEDBACK      = 13; // feedback - Thiago Passamani - Aguardando feedback */
   const WAITING       = 4;  // waiting
   const WAITING_LIST  = 14; // waiting_list - Thiago Passamani - Lista de espera */
   ...
   **/
   static function getStatusIconURL($status) {
      ...
      switch ($status) {
         ...
         case self::IN_ATTENDANCE : /* Thiago Passamani - Em atendimento */
            return $CFG_GLPI["root_doc"]."/pics/in_attendance.png";   

         case self::FEEDBACK : /* Thiago Passamani - Aguardando feedback */
            return $CFG_GLPI["root_doc"]."/pics/feedback.png";            

         case self::WAITING :
            return $CFG_GLPI["root_doc"]."/pics/waiting.png";

         case self::WAITING_LIST : /* Thiago Passamani - Lista de espera */
            return $CFG_GLPI["root_doc"]."/pics/waiting_list.png";
